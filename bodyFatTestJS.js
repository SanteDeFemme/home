function findBodyFat() {
    ...
    document.getElementById("resultBodyFat").innerHTML = "Body Fat: " + Math.round(bodyFatPercentage * 1000) / 1000;
    document.getElementById("resultLeanBodyMass").innerHTML = "Lean Body Mass: " + leanBodyMass;
